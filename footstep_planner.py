...
class LipTrajPlanner(LeafSystem):
    def __init__(self):
        ...
        self.parser.AddModels("humanoid_walker2.urdf") # humanoid with 2 arms fixed
    ...
    def DiscreteStateUpdate(self, context: Context, discrete_state: DiscreteValues) -> EventStatus:
        ...
        if fsm != prev_fsm:
            ...
            # robot_state = self.EvalVectorInput(context, self.robot_state_input_port_index).value()[:14]
